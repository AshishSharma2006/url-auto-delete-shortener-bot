...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/Eliteflix_Official')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('Owner ❤🖤', url='https://t.me/ashishsharmalegend'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/Eliteflix_Official')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('Owner ❤🖤', url='https://t.me/ashishsharmalegend') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
